...
CUDA_LAUNCH_BLOCKING=1 CUDA_VISIBLE_DEVICES=0 python reinforce.py --cuda --data data/val_casino_custformat --bsz 16 --clip 1 --context_file data/val_casino_custformat/selfplay_select.txt --eps 0.0 --gamma 0.95 --lr 0.5 --momentum 0.1 --nepoch 4 --nesterov --ref_text data/val_casino_custformat/train.txt --rl_clip 1 --rl_lr 0.2 --score_threshold 6 --sv_train_freq 4 --temperature 0.5 --alice_model ../logs/VAL_casino_custformat_supervised_30ep.pt --bob_model ../logs/VAL_casino_custformat_supervised_30ep.pt --rw_type own_points --output_model_file ../logs/VAL_casino_custformat_rl_selfish_4ep.pt
```
